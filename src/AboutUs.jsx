...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">At Paradise Nursery, we blend nature’s beauty with a touch of calm to create your perfect green haven</p>
      <p className="about-us-content">
        At Paradise Nursery, we’re dedicated to bringing the beauty of nature right to your doorstep. 
        Our mission is to offer a diverse collection of premium plants that not only elevate your spaces 
        but also promote a greener, healthier way of living. From air-purifying greens to soothing aromatic 
        varieties, we have something special for every plant lover.
      </p>
